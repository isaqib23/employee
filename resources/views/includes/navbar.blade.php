        ...
        <li class="nav-item dropdown user user-menu">
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                ...
                <p>
                    {{ Auth::user()->name }}
                    @if ( Auth::user()->employee )
                    - {{ Auth::user()->employee->desg }}, {{  (is_null(Auth::user()->employee->department)) ? "" : ucwords(Auth::user()->employee->department->name) }}
                    @endif 
                </p>
                </li>
                <!-- Menu Body --
                <li class="user-body text-center">
                    @if ( Auth::user()->employee )
                    <small>Member since {{ (is_null(Auth::user()->employee->join_date)) ? '' : Auth::user()->employee->join_date->format('d M, Y') }}</small>
                    @endif 
                 /.row -->
                </li>
                <!-- Menu Footer-->
