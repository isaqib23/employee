                        ...
                        <table class="table table-bordered table-hover" id="dataTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ ($employee->department) ? ucwords($employee->department->name) : "" }}</td>
                                    <td>{{ $employee->desg }}</td>
                                    <td>
                                        <a href="{{ route('employee.evaluation_friend', base64_encode($employee->user_id)) }}" class="btn btn-flat btn-info">Evaluate</a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
